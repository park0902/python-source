...
class Visualization:
    ...
    def RKSI_2016_category(self):
        if question == 1:
            ...
            title = {'mean': u'평균온도', 'max': u'최고온도', 'min': u'최저온도',
                     ...
                     'vis': u'가시도'}
            ax.set_title(u'월별 '+title[category]+'그래프')
            plt.xlabel(u'월')
    ...
    def Scatter(self):
        ...
        plt.xlabel(label[category1])
        plt.ylabel(label[category2])
    ...
    def Min_Dew_Vis(self):
        ...
        plt.yticks([0, 10, 20]);plt.xlabel('Days');plt.ylabel('Temperature & Visualization')
        plt.legend(loc=2)
