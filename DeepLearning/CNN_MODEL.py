...
class Model:
    ...
    def _build_net(self):
        with tf.variable_scope(self.name):
            ...
            with tf.name_scope('stem_layer') as scope:
                ...
                self.L1_sub = self.BN(input=self.L1_sub, scale=True, decay=0.99, training=self.training, name='stem_sub1_BN')
                ...
                self.L2_sub = tf.nn.conv2d(input=self.L1_sub, filter=self.W2_sub, strides=[1, 1, 1, 1], padding='VALID')  # 32x32 -> 30x30
                self.L2_sub = self.BN(input=self.L2_sub, scale=True, decay=0.99, training=self.training,name='stem_sub2_BN')
                ...
                self.L3_sub = tf.nn.conv2d(input=self.L2_sub, filter=self.W3_sub, strides=[1, 1, 1, 1], padding='VALID')  # 30x30 -> 28x28
                self.L3_sub = self.BN(input=self.L3_sub, scale=True, decay=0.99, training=self.training,name='stem_sub3_BN')
                ...
                self.L4_sub = tf.nn.conv2d(input=self.L3_sub, filter=self.W4_sub, strides=[1, 1, 1, 1], padding='VALID')  # 30x30 -> 28x28
                self.L4_sub = self.BN(input=self.L4_sub, scale=True, decay=0.99, training=self.training,name='stem_sub4_BN')
                # self.L4_sub = self.batch_norm(input=self.L4_sub, shape=self.L4_sub.get_shape()[-1], training=self.training, convl=True, name='stem_sub4_BN')
                self.L4_sub = self.parametric_relu(self.L4_sub, 'R4_sub')

                self.W5_sub = tf.get_variable(name='W5_sub', shape=[3, 3, 40, 80], dtype=tf.float32, initializer=tf.contrib.layers.variance_scaling_initializer())
                self.L5_sub = tf.nn.conv2d(input=self.L4_sub, filter=self.W5_sub, strides=[1, 1, 1, 1], padding='VALID')  # 28x28 -> 26x26
                self.L5_sub = self.BN(input=self.L5_sub, scale=True, decay=0.99, training=self.training,name='stem_sub5_BN')
                # self.L5_sub = self.batch_norm(input=self.L5_sub, shape=self.L5_sub.get_shape()[-1], training=self.training, convl=True, name='stem_sub5_BN')
            ...
            with tf.name_scope('inception_layer1') as scope:
                self.Inception_L1 = self.inception_A(self.L3_sub, 3, 120, name='inception_layer1')  # 26x26 -> 13x13
            ...
            with tf.name_scope('conv_layer1') as scope:
                ...
                self.L4 = self.BN(input=self.L4, scale=True, decay=0.99, training=self.training,name='conv1_BN')
            ...
            with tf.name_scope('conv_layer2') as scope:
                ...
                self.L5 = self.BN(input=self.L5, scale=True, decay=0.99, training=self.training, name='conv2_BN')
            ...
            with tf.name_scope('fc_layer1') as scope:
                self.W_fc1 = tf.get_variable(name='W_fc1', shape=[4 * 4 * 300, 650], dtype=tf.float32, initializer=tf.contrib.layers.variance_scaling_initializer())
                self.b_fc1 = tf.Variable(tf.constant(value=0.001, shape=[650], name='b_fc1'))
            ...
            with tf.name_scope('fc_layer2') as scope:
                self.W_fc2 = tf.get_variable(name='W_fc2', shape=[650, 650], dtype=tf.float32, initializer=tf.contrib.layers.variance_scaling_initializer())
                self.b_fc2 = tf.Variable(tf.constant(value=0.001, shape=[650], name='b_fc2'))
        ...
        with tf.control_dependencies(update_ops):
            self.optimizer = tf.train.AdamOptimizer(learning_rate=0.005, epsilon=1e-4).minimize(self.cost)
    ...
    def BN(self, input, center=True, scale=True, decay=0.99, epsilon=1e-3, training=True, name=None):
        return batch_norm(input, decay, center, scale, epsilon, is_training=training, name=name)
    ...
    def inception_A(self, x, n, output, name):
        ...
        with tf.variable_scope(name):
            ...
            L1x1 = self.BN(input=L1x1, scale=True, decay=0.99, training=self.training, name='inceptionA_L1x1_BN')
            # L1x1 = self.batch_norm(input=L1x1, shape=L1x1.get_shape()[-1], training=self.training, convl=True, name='inceptionA_L1x1_BN')
            ...
            L5x5_sub1 = self.BN(input=L5x5_sub1, scale=True, decay=0.99, training=self.training, name='inceptionA_L5x5_sub1_BN')
            # L5x5_sub1 = self.batch_norm(input=L5x5_sub1, shape=L5x5_sub1.get_shape()[-1], training=self.training, convl=True, name='inceptionA_L5x5_sub1_BN')
            ...
            L5x5_sub2 = self.BN(input=L5x5_sub2, scale=True, decay=0.99, training=self.training,name='inceptionA_L5x5_sub2_BN')
            # L5x5_sub2 = self.batch_norm(input=L5x5_sub2, shape=L5x5_sub2.get_shape()[-1], training=self.training, convl=True, name='inceptionA_L5x5_sub2_BN')
            ...
            L5x5_sub3 = self.BN(input=L5x5_sub3, scale=True, decay=0.99, training=self.training, name='inceptionA_L5x5_sub3_BN')
            # L5x5_sub3 = self.batch_norm(input=L5x5_sub3, shape=L5x5_sub3.get_shape()[-1], training=self.training, convl=True, name='inceptionA_L5x5_sub3_BN')
            ...
            L3x3_sub1 = self.BN(input=L3x3_sub1, scale=True, decay=0.99, training=self.training,name='inceptionA_L3x3_sub1_BN')
            # L3x3_sub1 = self.batch_norm(input=L3x3_sub1, shape=L3x3_sub1.get_shape()[-1], training=self.training, convl=True, name='inceptionA_L3x3_sub1_BN')
            ...
            L3x3_sub2 = self.BN(input=L3x3_sub2, scale=True, decay=0.99, training=self.training, name='inceptionA_L3x3_sub2_BN')
            # L3x3_sub2 = self.batch_norm(input=L3x3_sub2, shape=L3x3_sub2.get_shape()[-1], training=self.training, convl=True, name='inceptionA_L3x3_sub2_BN')
            ...
            L_pool_sub1 = self.BN(input=L_pool_sub1, scale=True, decay=0.99, training=self.training, name='inceptionA_L_pool_sub1_BN')
            # L_pool_sub1 = self.batch_norm(input=L_pool_sub1, shape=L_pool_sub1.get_shape()[-1], training=self.training, convl=True, name='inceptionA_L_pool_sub1_BN')
    ...
    def inception_B(self, x, n, output, name):
        ...
        with tf.variable_scope(name):
            ...
            L1x1 = tf.nn.conv2d(name='L1x1', input=x, filter=W1x1, strides=[1, 2, 2, 1], padding='SAME')
            L1x1 = self.BN(input=L1x1, scale=True, decay=0.99, training=self.training, name='inceptionB_L1x1_BN')
            # L1x1 = self.batch_norm(input=L1x1, shape=L1x1.get_shape()[-1], training=self.training, convl=True, name='inceptionB_L1x1_BN')
            ...
            L5x5_sub1 = tf.nn.conv2d(name='L5x5_sub1', input=x, filter=W5x5_sub1, strides=[1, 1, 1, 1], padding='SAME')
            L5x5_sub1 = self.BN(input=L5x5_sub1, scale=True, decay=0.99, training=self.training, name='inceptionB_L5x5_sub1_BN')
            # L5x5_sub1 = self.batch_norm(input=L5x5_sub1, shape=L5x5_sub1.get_shape()[-1], training=self.training, convl=True, name='inceptionB_L5x5_sub1_BN')
            ...
            L5x5_sub2 = tf.nn.conv2d(name='L5x5_sub2', input=L5x5_sub1, filter=W5x5_sub2, strides=[1, 1, 1, 1], padding='SAME')
            L5x5_sub2 = self.BN(input=L5x5_sub2, scale=True, decay=0.99, training=self.training, name='inceptionB_L5x5_sub2_BN')
            # L5x5_sub2 = self.batch_norm(input=L5x5_sub2, shape=L5x5_sub2.get_shape()[-1], training=self.training, convl=True, name='inceptionB_L5x5_sub2_BN')
            ...
            L5x5_sub3 = self.BN(input=L5x5_sub3, scale=True, decay=0.99, training=self.training, name='inceptionB_L5x5_sub3_BN')
            # L5x5_sub3 = self.batch_norm(input=L5x5_sub3, shape=L5x5_sub3.get_shape()[-1], training=self.training, convl=True, name='inceptionB_L5x5_sub3_BN')
            ...
            L5x5_sub4 = self.BN(input=L5x5_sub4, scale=True, decay=0.99, training=self.training, name='inceptionB_L5x5_sub4_BN')
            # L5x5_sub4 = self.batch_norm(input=L5x5_sub4, shape=L5x5_sub4.get_shape()[-1], training=self.training, convl=True, name='inceptionB_L5x5_sub4_BN')
            ...
            L5x5_sub5 = self.BN(input=L5x5_sub5, scale=True, decay=0.99, training=self.training, name='inceptionB_L5x5_sub5_BN')
            # L5x5_sub5 = self.batch_norm(input=L5x5_sub5, shape=L5x5_sub5.get_shape()[-1], training=self.training, convl=True, name='inceptionB_L5x5_sub5_BN')
            ...
            L3x3_sub1 = tf.nn.conv2d(name='L3x3_sub1', input=x, filter=W3x3_sub1, strides=[1, 1, 1, 1], padding='SAME')
            L3x3_sub1 = self.BN(input=L3x3_sub1, scale=True, decay=0.99, training=self.training, name='inceptionB_L3x3_sub1_BN')
            # L3x3_sub1 = self.batch_norm(input=L3x3_sub1, shape=L3x3_sub1.get_shape()[-1], training=self.training, convl=True, name='inceptionB_L3x3_sub1_BN')
            ...
            L3x3_sub2 = self.BN(input=L3x3_sub2, scale=True, decay=0.99, training=self.training, name='inceptionB_L3x3_sub2_BN')
            # L3x3_sub2 = self.batch_norm(input=L3x3_sub2, shape=L3x3_sub2.get_shape()[-1], training=self.training, convl=True, name='inceptionB_L3x3_sub2_BN')
            ...
            L3x3_sub3 = self.BN(input=L3x3_sub3, scale=True, decay=0.99, training=self.training, name='inceptionB_L3x3_sub3_BN')
            # L3x3_sub3 = self.batch_norm(input=L3x3_sub3, shape=L3x3_sub3.get_shape()[-1], training=self.training, convl=True, name='inceptionB_L3x3_sub3_BN')
            ...
            L_pool_sub1 = tf.nn.conv2d(name='L_pool_sub1', input=L_pool, filter=W_pool_sub1, strides=[1, 2, 2, 1], padding='SAME')
            L_pool_sub1 = self.BN(input=L_pool_sub1, scale=True, decay=0.99, training=self.training, name='inceptionB_L_pool_sub1_BN')
            # L_pool_sub1 = self.batch_norm(input=L_pool_sub1, shape=L_pool_sub1.get_shape()[-1], training=self.training, convl=True, name='inceptionB_L_pool_sub1_BN')
    ...
    def inception_C(self, x, n, output, name):
        ...
        with tf.variable_scope(name):
            ...
            L1x1 = tf.nn.conv2d(name='L1x1', input=x, filter=W1x1, strides=[1, 2, 2, 1], padding='SAME')
            L1x1 = self.BN(input=L1x1, scale=True, decay=0.99, training=self.training, name='inceptionC_L1x1_BN')
            # L1x1 = self.batch_norm(input=L1x1, shape=L1x1.get_shape()[-1], training=self.training, convl=True, name='inceptionC_L1x1_BN')
            ...
            L5x5_sub1 = tf.nn.conv2d(name='L5x5_sub1', input=x, filter=W5x5_sub1, strides=[1, 1, 1, 1], padding='SAME')
            L5x5_sub1 = self.BN(input=L5x5_sub1, scale=True, decay=0.99, training=self.training, name='inceptionC_L5x5_sub1_BN')
            # L5x5_sub1 = self.batch_norm(input=L5x5_sub1, shape=L5x5_sub1.get_shape()[-1], training=self.training, convl=True, name='inceptionC_L5x5_sub1_BN')
            ...
            L5x5_sub2 = self.BN(input=L5x5_sub2, scale=True, decay=0.99, training=self.training, name='inceptionC_L5x5_sub2_BN')
            # L5x5_sub2 = self.batch_norm(input=L5x5_sub2, shape=L5x5_sub2.get_shape()[-1], training=self.training, convl=True, name='inceptionC_L5x5_sub2_BN')
            ...
            L5x5_sub3 = tf.nn.conv2d(name='L5x5_sub3', input=L5x5_sub2, filter=W5x5_sub3, strides=[1, 1, 1, 1], padding='SAME')
            L5x5_sub3 = self.BN(input=L5x5_sub3, scale=True, decay=0.99, training=self.training, name='inceptionC_L5x5_sub3_BN')
            # L5x5_sub3 = self.batch_norm(input=L5x5_sub3, shape=L5x5_sub3.get_shape()[-1], training=self.training, convl=True, name='inceptionC_L5x5_sub3_BN')
            ...
            L5x5_sub4 = self.BN(input=L5x5_sub4, scale=True, decay=0.99, training=self.training, name='inceptionC_L5x5_sub4_BN')
            # L5x5_sub4 = self.batch_norm(input=L5x5_sub4, shape=L5x5_sub4.get_shape()[-1], training=self.training, convl=True, name='inceptionC_L5x5_sub4_BN')
            ...
            L3x3_sub1 = self.BN(input=L3x3_sub1, scale=True, decay=0.99, training=self.training, name='inceptionC_L3x3_sub1_BN')
            # L3x3_sub1 = self.batch_norm(input=L3x3_sub1, shape=L3x3_sub1.get_shape()[-1], training=self.training, convl=True, name='inceptionC_L3x3_sub1_BN')
            ...
            L3x3_sub2 = self.BN(input=L3x3_sub2, scale=True, decay=0.99, training=self.training, name='inceptionC_L3x3_sub2_BN')
            # L3x3_sub2 = self.batch_norm(input=L3x3_sub2, shape=L3x3_sub2.get_shape()[-1], training=self.training, convl=True, name='inceptionC_L3x3_sub2_BN')
            ...
            L3x3_sub3 = self.BN(input=L3x3_sub3, scale=True, decay=0.99, training=self.training, name='inceptionC_L3x3_sub3_BN')
            # L3x3_sub3 = self.batch_norm(input=L3x3_sub3, shape=L3x3_sub3.get_shape()[-1], training=self.training, convl=True, name='inceptionC_L3x3_sub3_BN')
            ...
            W_pool_sub1 = tf.get_variable(name='W_pool_sub1', shape=[1, 1, C, 20], dtype=tf.float32, initializer=tf.contrib.layers.variance_scaling_initializer())
            L_pool_sub1 = tf.nn.conv2d(name='L_pool_sub1', input=L_pool, filter=W_pool_sub1, strides=[1, 2, 2, 1], padding='SAME')
            L_pool_sub1 = self.BN(input=L_pool_sub1, scale=True, decay=0.99, training=self.training, name='inceptionC_L_pool_sub1_BN')
            # L_pool_sub1 = self.batch_norm(input=L_pool_sub1, shape=L_pool_sub1.get_shape()[-1], training=self.training, convl=True, name='inceptionC_L_pool_sub1_BN')
